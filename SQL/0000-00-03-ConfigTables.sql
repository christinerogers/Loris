...
INSERT INTO ConfigSettings (Name, Description, Visible, AllowMultiple, DataType, Parent, Label, OrderNumber) SELECT 'issue_tracker_url', 'Issue tracker URL', 1, 0, 'text', ID, 'Issue tracker URL', 3 FROM ConfigSettings WHERE Name="www";
...
INSERT INTO Config (ConfigID, Value) SELECT ID, "http://localhost/issue_tracker" FROM ConfigSettings WHERE Name="issue_tracker_url";
