<script type="text/javascript" src="GetJS.php?Module=genomic_browser&file=genomicMenuFilter.js"></script>
...
<!--                            <th><a href="main.php?test_name=genomic_browser&filter[order][field]={$headers[header].name}&filter[order][fieldOrder]={$headers[header].fieldOrder}">{$headers[header].displayName} {$headers[header].name} {$headers[header].fieldOrder}</a></th-->
